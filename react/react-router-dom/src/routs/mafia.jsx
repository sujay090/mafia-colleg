...
export const Mafia = () => {
  return (
    <>
      <Navbar />
      <div className="px-8 flex gap-3 mt-8 justify-between flex-row-reverse">
        <div className=" shadow-2xl p-3 w-[70%] h-[100%]">
          <div className="w-[100%]">
            <img
              className="w-[100%]"
              src="https://wallpapers.com/images/high/coolest-naruto-and-sasuke-7amzrohggubvvdng.webp"
              alt="nature photo"
            />
          </div>
          <div className="w-[100%]">
          ...
          <div className="shadow-xl p-3">
            <div className="w-[100%]">
              <img
                ...
                src="https://wallpapers.com/images/high/shy-child-hinata-o6be7hidav0ssxao.webp"
                alt=""
              />
            </div>
